/-!
# littlewood-conjecture-canonical-lane Lean migration boundary
...
`LittlewoodConjectureCanonicalLaneLean/SourcePackage.lean`.
...
def sourceRepository : String := "littlewood-conjecture-canonical-lane"
def sourceUrl : String := "https://github.com/HautevilleHouse/littlewood-conjecture-canonical-lane"
def sourceDescription : String := "Canonical-lane closure package for Littlewood's Conjecture: admissible-class formulation, projection gates, local-to-global bridge, and carried remainder."
def sourceClassification : String := "abstract_math_theorem_repo"
def sourceTopics : List String := ["littlewood-conjecture", "mathematical-proof", "number-theory", "reproducibility", "diophantine-approximation", "ergodic-theory", "homogeneous-dynamics", "canonical-lane", "local-to-global", "manifold-constrained"]
