# Littlewood Conjecture — Canonical Lane Mathlib
...
```bash
git clone https://github.com/HautevilleHouse/littlewood-conjecture-canonical-lane-mathlib.git
cd littlewood-conjecture-canonical-lane-mathlib
lake exe
lake build
```
